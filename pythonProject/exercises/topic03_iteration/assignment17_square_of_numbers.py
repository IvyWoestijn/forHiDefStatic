...
**Tip:** you know that 81 is the largest value you will ever have to print
and so all the numbers will consist of 1 or 2 digits.

**Side note:** By the end of the semester,
we expect you to use functions to solve this problem.
For now, make it without function and revisit the exercise
